...
;; load external `invoice.css` file, based on:
;;   - https://www.gnu.org/software/guile/manual/html_node/Textual-I_002fO.html#Textual-I_002fO-1
;;   - https://stackoverflow.com/questions/51972427/how-can-i-read-file-loaded-in-a-variable-in-guile
(use-modules (ice-9 textual-ports))
(define base-css (call-with-input-file (gnc-build-userdata-path "invoice.css") get-string-all))
